...
import com.github.noamm9.config.types.CategorySetting
...
object BloodESP: Feature("Highlights the blood room before dungeon start to help you with 0s Bloodrush.") {
    private val box by BooleanConfig("Room Box", true).withDescription("Draws a box around the Blood room.").section("Options")
    private val tracer by BooleanConfig("Door Tracer", true).withDescription("Draws a tracer to the Blood room's door.")
