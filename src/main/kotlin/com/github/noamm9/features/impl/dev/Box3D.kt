...
object Box3D: Feature("Replaces the Glow ESP with 3D boxes") {
    ...
    private val outlineOpacity by NumberConfig("Outline Opacity", 35, 0, 100, 1).hideIf { mode.value == 1 }
    private val fillOpacity by NumberConfig("Fill Opacity", 35, 0, 100, 1).hideIf { mode.value == 0 }

    //#if CHEAT
    private val phase by BooleanConfig("Phase", true)
    //#endif
