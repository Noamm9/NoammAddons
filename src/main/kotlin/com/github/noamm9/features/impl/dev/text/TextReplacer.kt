...
object TextReplacer: AhoCorasick() {
    ...
    @JvmStatic fun handleComponent(component: Component) = componentCache.getOrPut(component) { replaceComponent(component) }
    @JvmStatic fun handleCharSequence(seq: FormattedCharSequence) = sequenceCache.getOrPut(seq) { replaceCharSequence(seq) }
    ...
    private val cache = Collections.synchronizedMap(WeakHashMap<String, String>(1000))
    private val componentCache = Collections.synchronizedMap(WeakHashMap<Component, Component>(500))
    private val sequenceCache = Collections.synchronizedMap(WeakHashMap<FormattedCharSequence, FormattedCharSequence>(500))
}