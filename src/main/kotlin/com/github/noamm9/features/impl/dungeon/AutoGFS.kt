...
object AutoGFS: Feature("Automatically refills dungeon items from your sacks using /gfs while in dungeons.") {
    ...
    private val refillTwilight by ToggleSetting("Refill Twilight Arrow Poison (TWAP)")
    ...
    private val twilightAmount by SliderSetting("TWAP Amount", 8, 4, 8, 1).withDescription("The number of TWAP you want the auto to pull out of sacks").showIf { (p5Twilight.value || pyTwilight.value) && refillTwilight.value }
