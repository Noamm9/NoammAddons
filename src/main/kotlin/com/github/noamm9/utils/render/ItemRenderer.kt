...
import com.github.noamm9.mixin.IPictureInPictureRenderer
...
class ItemRenderer(vertexConsumers: MultiBufferSource.BufferSource): PictureInPictureRenderer<ItemRenderer.ItemState>(vertexConsumers) {
    ...
    private val textureView by lazy { TextureSetup.singleTexture((this as IPictureInPictureRenderer).getTextureView().apply { texture().setTextureFilter(FilterMode.NEAREST, false) }) }
