...
class MapSetting<K, V>(name: String, private val defaults: Map<K, V> = emptyMap(), private val type: Type): ConfigHolder<MutableMap<K, V>>(name, defaults.toMutableMap()), Savable {
