...
import noammaddons.features.impl.general.PartyHelper
...
object AutoRequeue: Feature() {
    ...
    private val floor get() = PartyHelper.NUMBERS_TO_TEXT[LocationUtils.dungeonFloorNumber ?: 0]
    ...
    fun onRunEnd(event: DungeonEvent.RunEndedEvent) {
        if (checkParty) {
            ...
            if (PartyHelper.downtimeList.isNotEmpty()) return feedBackMessage("There are players in downtime!")
        }
