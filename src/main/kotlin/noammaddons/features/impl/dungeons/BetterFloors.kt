...
object BetterFloors: Feature("Basically my FunnyMapExtras's config port. Place and remove some blocks in the boss fight") {
    ...
    private val f7Config = DataDownloader.loadJson<Map<String, List<Map<String, Double>>>>("betterFloors/F7BossCoords.json")
    private val f6Config = DataDownloader.loadJson<Map<String, List<Map<String, Double>>>>("betterFloors/F6BossCoords.json")
    private val f5Config = DataDownloader.loadJson<Map<String, List<Map<String, Double>>>>("betterFloors/F5BossCoords.json")
