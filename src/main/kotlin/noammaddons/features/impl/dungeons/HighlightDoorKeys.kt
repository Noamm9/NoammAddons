...
object HighlightDoorKeys: Feature("Highlight blood/wither door key in the world") {
    private val bloodColor = ColorSetting("Blood Key Color", Color.RED.withAlpha(60))
    private val witherColor = ColorSetting("Wither Key Color", Color.BLACK.withAlpha(60))
    private var doorKey: Pair<Entity, Color>? = null
    override fun init() {
        addSettings(bloodColor, witherColor)
        onWorldLoad { doorKey = null }
    }
