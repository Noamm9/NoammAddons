...
object RemoveUselessMessages: Feature("Hides useless chat messages from appearing in chat without fucking other mods") {
    @SubscribeEvent
    fun onNewChatMessage(event: AddMessageToChatEvent) {
        event.isCanceled = RegexsWithoutFormatting.any {
            it.matches(event.component.noFormatText)
